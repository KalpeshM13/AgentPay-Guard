...
/* ── stat block ── */
const STATS = [
  { label: "WALLET_STATE", value: "FROZEN" },
  { label: "ON_CHAIN_LIMIT", value: "0.01 ETH" },
  { label: "OWNER_KEY", value: "ADMIN_AUTH" },
  { label: "AGENT_KEY", value: "RESTRICTED_EXEC" },
]
          ...
          <div className="flex-1 flex flex-col justify-between px-5 py-6 lg:py-8">
            <div className="flex flex-col gap-6">
              ...
              >
                THE PAIN
                <br />
                <span className="text-[#ea580c]">POINT</span>
              </motion.h2>
              ...
              >
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  Once an agent holds a wallet, "asking it nicely" to behave isn't a control — it's a hope. There's no reliable way today to cap what an agent can spend, restrict who it can pay, or stop it mid-transaction if something goes wrong.
                </p>
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  Most controls live in the agent's own logic rather than being enforced independently of it.
                </p>
              </motion.div>
